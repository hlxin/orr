...
#        best_checkpoint = torch.load('model_best_train_idx_val_' + str(self.idx_validation) + '_idx_test_' + str(self.idx_test) + '.pth.tar')
        best_checkpoint = torch.load('model_best_train_idx_val_'+str(self.idx_validation)+'_idx_test_'+str(self.idx_test)+'.pth.tar', map_location=torch.device('cpu'))
...
#        np.savetxt('parm_train_idx_val_' + str(self.idx_validation) + '_idx_test_' + str(self.idx_test) + '.txt', parm.detach().cpu().numpy())
        parm.detach().cpu().numpy().tofile('parm_train_idx_val_' + str(self.idx_validation) + '_idx_test_' + str(self.idx_test) +'.csv',sep=',')
...
#        np.savetxt('parm_validation_idx_val_' + str(self.idx_validation) + '_idx_test_' + str(self.idx_test) + '.txt', parm.detach().cpu().numpy())
        parm.detach().cpu().numpy().tofile('parm_validation_idx_val_' + str(self.idx_validation) + '_idx_test_' + str(self.idx_test) +'.csv',sep=',')        
...
#        np.savetxt('parm_test_idx_val_' + str(self.idx_validation) + '_idx_test_' + str(self.idx_test) + '.txt', parm.detach().cpu().numpy())
        parm.detach().cpu().numpy().tofile('parm_test_idx_val_' + str(self.idx_validation) + '_idx_test_' + str(self.idx_test) +'.csv',sep=',')
